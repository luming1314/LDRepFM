...
def parse_opt() -> Namespace:
    ...
    parser.add_argument('--weights', type=str, default='cache/a1/065.pth', help='pretrained weights path')
    parser.add_argument('--deploy_weight', type=str, default='cache/a2/065.pth', help='pretrained weights path')
